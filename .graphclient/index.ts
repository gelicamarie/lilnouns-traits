...
export type Auction_orderBy = 'id' | 'noun' | 'amount' | 'startTime' | 'endTime' | 'bidder' | 'settled' | 'bids'
...
export type Bid_orderBy = 'id' | 'noun' | 'amount' | 'bidder' | 'blockNumber' | 'txIndex' | 'auction' | 'blockTimestamp'
...
export type Noun_orderBy = 'id' | 'seed' | 'owner' | 'votes'
...
export type ProposalStatus = 'PENDING' | 'ACTIVE' | 'CANCELLED' | 'VETOED' | 'QUEUED' | 'EXECUTED'
...
export type Seed_orderBy = 'id' | 'background' | 'body' | 'accessory' | 'head' | 'glasses'
...
> = ResolversObject<{
  ...
  nouns?: Resolver<
    Array<ResolversTypes['Noun']>,
    ParentType,
    ContextType,
    RequireFields<AccountnounsArgs, 'skip' | 'first'>
  >
...
> = ResolversObject<{
  ...
  tokenHoldersRepresented?: Resolver<
    Array<ResolversTypes['Account']>,
    ParentType,
    ContextType,
    RequireFields<DelegatetokenHoldersRepresentedArgs, 'skip' | 'first'>
  >
  nounsRepresented?: Resolver<
    Array<ResolversTypes['Noun']>,
    ParentType,
    ContextType,
    RequireFields<DelegatenounsRepresentedArgs, 'skip' | 'first'>
  >
  votes?: Resolver<
    Array<ResolversTypes['Vote']>,
    ParentType,
    ContextType,
    RequireFields<DelegatevotesArgs, 'skip' | 'first'>
  >
  proposals?: Resolver<
    Array<ResolversTypes['Proposal']>,
    ParentType,
    ContextType,
    RequireFields<DelegateproposalsArgs, 'skip' | 'first'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>
...
export type GovernanceResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes['Governance'] = ResolversParentTypes['Governance'],
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type NounResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes['Noun'] = ResolversParentTypes['Noun'],
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  ...
  votes?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<NounvotesArgs, 'skip' | 'first'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}>
...
> = ResolversObject<{
  seed?: Resolver<
    Maybe<ResolversTypes['Seed']>,
    ParentType,
    ContextType,
    RequireFields<QueryseedArgs, 'id' | 'subgraphError'>
  >
  seeds?: Resolver<
    Array<ResolversTypes['Seed']>,
    ParentType,
    ContextType,
    RequireFields<QueryseedsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  noun?: Resolver<
    Maybe<ResolversTypes['Noun']>,
    ParentType,
    ContextType,
    RequireFields<QuerynounArgs, 'id' | 'subgraphError'>
  >
  nouns?: Resolver<
    Array<ResolversTypes['Noun']>,
    ParentType,
    ContextType,
    RequireFields<QuerynounsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  bid?: Resolver<
  ...
  delegate?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerydelegateArgs, 'id' | 'subgraphError'>
  >
  delegates?: Resolver<
    Array<ResolversTypes['Delegate']>,
    ParentType,
    ContextType,
    RequireFields<QuerydelegatesArgs, 'skip' | 'first' | 'subgraphError'>
  >
  proposal?: Resolver<
  ...
  >
  governance?: Resolver<
    Maybe<ResolversTypes['Governance']>,
    ParentType,
    ContextType,
    RequireFields<QuerygovernanceArgs, 'id' | 'subgraphError'>
  >
  governances?: Resolver<
    Array<ResolversTypes['Governance']>,
    ParentType,
    ContextType,
    RequireFields<QuerygovernancesArgs, 'skip' | 'first' | 'subgraphError'>
  >
...
> = ResolversObject<{
  seed?: SubscriptionResolver<
    Maybe<ResolversTypes['Seed']>,
    'seed',
    ParentType,
    ContextType,
    RequireFields<SubscriptionseedArgs, 'id' | 'subgraphError'>
  >
  seeds?: SubscriptionResolver<
    Array<ResolversTypes['Seed']>,
    'seeds',
    ParentType,
    ContextType,
    RequireFields<SubscriptionseedsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  noun?: SubscriptionResolver<
    Maybe<ResolversTypes['Noun']>,
    'noun',
    ParentType,
    ContextType,
    RequireFields<SubscriptionnounArgs, 'id' | 'subgraphError'>
  >
  nouns?: SubscriptionResolver<
    Array<ResolversTypes['Noun']>,
    'nouns',
    ParentType,
    ContextType,
    RequireFields<SubscriptionnounsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  ...
  >
  delegate?: SubscriptionResolver<
    Maybe<ResolversTypes['Delegate']>,
    'delegate',
    ParentType,
    ContextType,
    RequireFields<SubscriptiondelegateArgs, 'id' | 'subgraphError'>
  >
  delegates?: SubscriptionResolver<
    Array<ResolversTypes['Delegate']>,
    'delegates',
    ParentType,
    ContextType,
    RequireFields<SubscriptiondelegatesArgs, 'skip' | 'first' | 'subgraphError'>
  >
  ...
  >
  governance?: SubscriptionResolver<
    Maybe<ResolversTypes['Governance']>,
    'governance',
    ParentType,
    ContextType,
    RequireFields<SubscriptiongovernanceArgs, 'id' | 'subgraphError'>
  >
  governances?: SubscriptionResolver<
    Array<ResolversTypes['Governance']>,
    'governances',
    ParentType,
    ContextType,
    RequireFields<SubscriptiongovernancesArgs, 'skip' | 'first' | 'subgraphError'>
  >
...
> = ResolversObject<{
  ...
  nouns?: Resolver<
    Maybe<Array<ResolversTypes['Noun']>>,
    ParentType,
    ContextType,
    RequireFields<VotenounsArgs, 'skip' | 'first'>
  >
...
export type SubscriptionLilnounsSdk = {
  ...
  /** null **/
  auctions: InContextSdkMethod<
    LilnounsTypes.Subscription['auctions'],
    LilnounsTypes.SubscriptionauctionsArgs,
    MeshContext
  >
  /** null **/
  ...
  accounts: InContextSdkMethod<
    LilnounsTypes.Subscription['accounts'],
    LilnounsTypes.SubscriptionaccountsArgs,
    MeshContext
  >
  /** null **/
  delegate: InContextSdkMethod<
    LilnounsTypes.Subscription['delegate'],
    LilnounsTypes.SubscriptiondelegateArgs,
    MeshContext
  >
  /** null **/
  delegates: InContextSdkMethod<
    LilnounsTypes.Subscription['delegates'],
    LilnounsTypes.SubscriptiondelegatesArgs,
    MeshContext
  >
  /** null **/
  proposal: InContextSdkMethod<
    LilnounsTypes.Subscription['proposal'],
    LilnounsTypes.SubscriptionproposalArgs,
    MeshContext
  >
  /** null **/
  proposals: InContextSdkMethod<
    LilnounsTypes.Subscription['proposals'],
    LilnounsTypes.SubscriptionproposalsArgs,
    MeshContext
  >
  /** null **/
  ...
  /** null **/
  governance: InContextSdkMethod<
    LilnounsTypes.Subscription['governance'],
    LilnounsTypes.SubscriptiongovernanceArgs,
    MeshContext
  >
  /** null **/
  governances: InContextSdkMethod<
    LilnounsTypes.Subscription['governances'],
    LilnounsTypes.SubscriptiongovernancesArgs,
    MeshContext
  >
  /** Access to subgraph metadata **/
